...
from golem.core.models import ContextPackage, Decision, EvidenceRef, StageName
...
class OptimizationAdvisor(Protocol):
    """Optional boundary for cost optimizers such as Hatchling.

    Golem must remain able to run without an advisor. Advisors propose lower
    cost routes, cache use, compression, or fallback; Golem keeps final
