...
golem_status ex_inputs(golem_document_store *s,struct json_object *contract,const char *kind,struct json_object **out);
...
golem_status ex_markdown(golem_document_store *s,struct json_object *meta,golem_execution_reply *out);
...
golem_status ex_execute(golem_document_store *s,struct json_object *checkpoint,
    const golem_digest *checkpoint_digest,struct json_object *manifest,const char *attempt,
