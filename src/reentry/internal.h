...
golem_status re_decide(golem_document_store *s, struct json_object *request, uint64_t now,
...
golem_status re_next(golem_document_store *s, const char **action, const char **kind,
                     const char **reason);
golem_status re_context(golem_document_store *s, struct json_object *manifest, uint64_t *total,
                        uint64_t budget);
golem_status re_export(golem_document_store *s, struct json_object *manifest,
