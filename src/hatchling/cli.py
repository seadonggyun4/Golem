...
from hatchling.adapters.local import LocalNoopAdapter
from hatchling.core.models import AcceptanceCriterion, AutonomyMode, StageGraph, StageName, WorkCapsule, WorkRun
...
def default_capsule() -> WorkCapsule:
    ...
    return WorkCapsule(
        ...
        goal="Exercise the Hatchling MVP work cycle.",
        scope=("samples/**",),
...
def main() -> int:
    ...
    if args.command == "smoke-run":
        evidence_store = EvidenceStore(Path(".hatchling/evidence"))
