...
See [the document registry contract](document-registry.md) for schemas,
...
[discovery, research and scope](discovery.md) for the complete workflow.
...
See [AWE concepts](awe-concepts.md) and [MVP runtime](mvp-runtime.md).
...
and document presence is not QA approval. See [workflow usage and contracts](workflow.md).
...
agent or equate submission with QA approval. See [session protocol and examples](agent-session.md).
...
See [the execution contract and CLI workflow](execution.md) and
...
See [the reentry contract and workflow](reentry.md).
...
See [completion, reporting and recovery](completion.md) for commands,
