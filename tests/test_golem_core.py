...
from golem.adapters.base import StageResult
...
from golem.core.optimization import BudgetPolicy, OptimizationAction, OptimizationProposal
...
class GolemCoreTests(unittest.TestCase):
